" COPY OF GLOBAL SYNTAX FILE FOR R WITH THE FOLLOWING CHANGES:
" Assignment operator ('<-') gets mapped to Operator instead of Statement
" Dollar Sign gets mapped to Operator instead of SpecialChar
"
" Vim syntax file
" Language:	      R (GNU S)
